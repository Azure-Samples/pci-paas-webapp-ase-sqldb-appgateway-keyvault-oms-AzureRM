...
### Backend Certificate whitelist

1. Purchase the domain name and the SSL certificate from authorized Certificate Authority. 

2. Add .pfx file and aseauthcert in WAF HTTP settings

3. Add the above .pfx files into webapp as well.

4. Check the health between WAF-AppGateway and ASE
